...
##                           ceil(N * column_mult)
##   "grant_chips:N"         gain N gambit chips. Unscaled — chips are
##                           discrete slot-unlocks, not magnitudes.
## "full" and "grant_chips" never scale. Numeric arguments to the other
## effects scale via the owning EventDef.column_effect_multiplier and the
## column the event fires in. TODO: refactor to typed EventEffect Resource
## subclasses once the inventory system lands and the effect vocabulary
## stabilizes.
